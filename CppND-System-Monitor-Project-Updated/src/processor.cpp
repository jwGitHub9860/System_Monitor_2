...
float Processor::Utilization()
{
    ...
    float Prev_Idle = LinuxParser::kIdle_;    // make Current active time, Previous active time
    float Prev_Iowait = LinuxParser::kIOwait_;    // make Current active time, Previous active time
    ...
    float Prev_User = LinuxParser::kUser_;    // make Current active time, Previous active time
    float Prev_Nice = LinuxParser::kNice_;    // make Current total time, Previous total time
    float Prev_System = LinuxParser::kSystem_;    // make Current total time, Previous total time
    float Prev_Irq = LinuxParser::kIRQ_;    // make Current total time, Previous total time
    float Prev_Softirq = LinuxParser::kSoftIRQ_;    // make Current total time, Previous total time
    float Prev_Steal = LinuxParser::kSteal_;    // make Current total time, Previous total time
